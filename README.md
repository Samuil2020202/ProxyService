...
- Get the handler script from [here](https:///github.com/Samuil2020202/ProxyService)/blob/master/client/ProxyService.mod.lua) and put it in a module script in ServerScriptService.
